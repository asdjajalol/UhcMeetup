...
public class KitFile {
    ...
    public void reloadConfig() {
        if (this.configFile == null){
            this.configFile = new File(this.plugin.getDataFolder(), "kit.yml");
        }
        this.fileConfig = YamlConfiguration.loadConfiguration(this.configFile);
        InputStream defaultStream = this.plugin.getResource("kit.yml");
    ...
    public void saveDefaultConfig(){
        ...
        if (!this.configFile.exists()){
            this.plugin.saveResource("kit.yml", false);
        }
    }
}
